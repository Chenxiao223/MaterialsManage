 ...
 */
public class TreeViewItemClickListener3 implements OnItemClickListener {
    ...
    public TreeViewItemClickListener3(TreeViewAdapter treeViewAdapter) {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
        ...
        if (!element.isHasChildren()) {
            String name = element.getContentText().substring(element.getContentText().indexOf(" "));//货位名称
            RequestGoodsAllocationInfo(name);
            return;
        }
