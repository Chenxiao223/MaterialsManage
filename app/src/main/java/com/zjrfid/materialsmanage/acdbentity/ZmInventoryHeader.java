 ...
 */
public class ZmInventoryHeader {
    ...
    public String getHpcvGuidChs() {
        return hpcvGuidChs;
    }

    public void setHpcvGuidChs(String hpcvGuidChs) {
        this.hpcvGuidChs = hpcvGuidChs;
    }
