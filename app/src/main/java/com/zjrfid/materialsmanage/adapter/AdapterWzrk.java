...
public class AdapterWzrk extends BaseAdapter {
    private Context context;
    private LayoutInflater inflater;
    private ArrayList<HashMap<String, String>> list;
    private int i = 0;

    public AdapterWzrk(Context context, ArrayList<HashMap<String, String>> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHold.text27 = (TextView) convertView.findViewById(R.id.text27);
            viewHold.text28 = (TextView) convertView.findViewById(R.id.text28);
            viewHold.text29 = (TextView) convertView.findViewById(R.id.text29);
            viewHold.text30 = (TextView) convertView.findViewById(R.id.text30);
        ...
        viewHold.text27.setText(list.get(position).get("content27"));
        viewHold.text28.setText(list.get(position).get("content28"));
        viewHold.text29.setText(list.get(position).get("content29"));
        viewHold.text30.setText(list.get(position).get("content30"));
    ...
    public static class ViewHold {
        ...
        TextView text1, text2, text3, text4, text5, text6, text7,text8, text9,
                ...
                text18, text19,text20, text21,text22, text23,text24, text25, text26,text27, text28,text29, text30,tv_digital;
    }
